...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=ai4QiI4D#6F8n4jw6qjaIWPGji5MAVsv50N1k7qkgz3QA7lzBtvY' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '917760274059' : process.env.SUDO,
SESSION_NAME: process.env.PORT === undefined ? "zoya" : process.env.SESSION_NAME,
...
SEEDER_GMAIL: process.env.SEEDER_GMAIL === undefined ? "zorozeee639@gmail.com" : process.env.SEEDER_GMAIL,
